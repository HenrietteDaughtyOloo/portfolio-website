export const myAboutData = [
    {
        cover:"https://res.cloudinary.com/drt1jptk7/image/upload/v1710850118/io4lh0magvksas9ctaxu-removebg-preview_rxx2hl.png",
        data:"Inclusivity weaves diverse voices together, paving the way for a thriving society.",
        title: "Mantra"
    },

    {
        cover:"https://res.cloudinary.com/drt1jptk7/image/upload/v1710848912/vision_ibfd5g.png",
        data:" To break down barriers that restrict the accessibility of resources, creating an environment where everyone can access essential resources and unleash their true potential, thus contributing meaningfully to the collective progress of society.",
        title: "Vision"
    },
    {
        cover:"https://res.cloudinary.com/drt1jptk7/image/upload/v1710849753/image-removebg-preview_ok87nr.png",
        data:"She prides herself on writing high quality code across the tech stack:  Kotlin, Python, Javascript, leveraging frameworks like, React, Django and Android SDK.",
        title: "Tech Stack"
    },
...
export const projectsData =[
      ...
      },
    {
      ...
      {
        cover: "https://res.cloudinary.com/drt1jptk7/image/upload/v1710860314/undraw_Online_payments_re_y8f2_e9wzrv.png",
        name: "Billz App",
      ...
      },
      {
        ...
        cover: "https://res.cloudinary.com/drt1jptk7/image/upload/v1710868957/ykxbo6azn1p6k3obodpz-removebg-preview_crcbq3.png",
        name: "Green Revive Backend",
 ...
 export const progressData = [
      { label: 'Android Development', progress: 80},
      { label: 'Product Management', progress: 80 },
      { label: 'Python Development', progress: 70 },
      { label: 'Web-Development', progress: 70 },
